...
class AuthController extends GetxController {
  final String userDataKey = 'user-data';
  ...
  Future<void> saveUserData(String token, UserModel model) async {
    ...
    await sharedPreferences.setString(userDataKey, jsonEncode(model.toJson()));
  ...
  Future<void> getUserData() async {
    final SharedPreferences sharedPreferences =
        await SharedPreferences.getInstance();
    String? userData = sharedPreferences.getString(userDataKey);
